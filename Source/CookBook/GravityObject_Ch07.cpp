...
// Add default functionality here for any IGravityObject_Ch07 functions that are not pure virtual.

void IGravityObject_Ch07::EnableGravity()
{
...
void IGravityObject_Ch07::DisableGravity()
{
	AActor* ThisAsActor = Cast<AActor>(this);
	if (ThisAsActor != nullptr)
	{
